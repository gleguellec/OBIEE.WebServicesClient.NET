The sawxFilter class is an XML document that represents a prompted filter. It is added to the filterExpressions string array of the ReportParams object that will be passed to the executeXMLQuery() function of the XmlViewServiceSoapClient instance.
